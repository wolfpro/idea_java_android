...
<!-- Mirrored from developer.alexanderklimov.ru/android/views/addview.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Jul 2014 15:20:21 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
<meta charset=utf-8>
<title>Android: Программное добавление и удаление виджета</title>
...
<h1 class="text-warning">Программное добавление и удаление виджета</h1>

<p>
<a href="#addview">Добавляем виджет</a><br>
<a href="#removeview">Удаляем виджет</a><br>
</p>

<p>Обычно мы размещаем виджеты через XML. Но можно это делать и программно. Такой подход используется при динамическом размещении, когда неизвестно, сколько элементов должно быть на экране.</p>

<h2 class="text-warning" id="addview">Добавляем виджет</h2>

<p>Допустим у нас есть простейшая разметка.</p>
...
<p>Пустая компоновка LinearLayout с идентификатором <b>mainlayout</b> не содержит вложенных виджетов. Через метод <b>addView(view)</b> класса LinearLayout мы можем добавить нужный нам элемент.</p>
...
<h2 class="text-warning" id="removeview">Удаляем виджет</h2>

<p>Существует и обратный метод для удаления вида - <b>removeView()</b>, а также метод <b>removeAllViews()</b>, удаляющий все дочерние элементы родителя. Рассмотрим следующий пример. Создадим разметку, где компонент LinearLayout с идентификатором <b>master</b> будет родителем для будущих элементов, которые мы будем добавлять или удалять:</p>

<h3 class="text-success">activity_main.xml</h3>
...
<p>Создадим пару дополнительных разметок, которые будет дочерними элементами для FrameLayout. Мы будем управлять ими программно.</p>

<h3 class="text-success">layer1.xml</h3>
...
<h3 class="text-success">layer2.xml</h3>
...
<p>Напишем код, который будет добавлять или удалять компоновки через флажки.</p>
...
<p>Обратите внимание, что добавление идёт в том порядке, как мы отмечаем флажки. Если мы отметим флажком второй CheckBox, то сначала на экране появится блок с компоновкой layer2.xml, а уже ниже компоновка layer1.xml. На скриншоте представлен этот вариант.</p>

<p><img src="addview1.png" alt="addView" width="240" height="400"></p>

<h2 class="text-warning">Дополнительное чтение</h2>

<p><a href="../animation/animatelayoutchanges.html">Добавление элемента через анимацию (Android 4)</a></p>

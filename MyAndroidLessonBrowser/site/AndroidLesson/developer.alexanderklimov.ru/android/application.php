...
<!-- Mirrored from developer.alexanderklimov.ru/android/application.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Jul 2014 15:19:14 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
<meta charset=utf-8>
<title>Android: Класс Application и глобальные переменные</title>
...
<h1 class="text-warning">Класс Application и глобальные переменные</h1>
<p>Третий месяц обучения (закрытая зона)</p>

<p>
<a href="#globalvars">Глобальные переменные</a><br>
<a href="#baseclass">Наследуемся от базового класса</a><br>
<a href="#application">Класс Application</a><br>
</p>

<p>При разработке сложных приложений, состоящих из множества экранов, бывает нужно чтобы какие-то переменные или методы были доступны из всех активностей. Например, при работе с базой данной пишется класс, который обеспечивает соединение с БД и выборку данных. Но, создавать экземпляр этого класса в каждой активности весьма расточительно. Хочется иметь один экземпляр и обращаться к нему из любой точки приложения.</p>

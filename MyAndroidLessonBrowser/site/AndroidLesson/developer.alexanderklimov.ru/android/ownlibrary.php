...
<!-- Mirrored from developer.alexanderklimov.ru/android/ownlibrary.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Jul 2014 15:20:58 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
<meta charset=utf-8>
<title>Android: Создаём собственную библиотеку</title>
...
<h1 class="text-warning">Создаём собственную библиотеку</h1>

<p>Закрытая зона/5-й месяц</p>

<p>Рассмотрим создание собственной библиотеки. Вам уже не раз приходилось пользоваться чужими библиотеками. Пора научиться создавать собственные библиотеки, которые можно будет подключать к своим проектам или делиться ими с людьми.</p>

<p>Если расширением для приложений является apk-файл, то для библиотек - это jar-файл. JAR-файл нельзя распространять отдельно в Google Play, его можно использовать только в составе приложений.</p>

<p>Наверняка, вы замечали, что при создании нового проекта, флажок для создания библиотеки всегда оставался нетронутым. Давайте теперь попробуем его задействовать.</p>

...
<!-- Mirrored from developer.alexanderklimov.ru/android/youtubeandroidplayerapi.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Jul 2014 15:19:17 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
<meta charset=utf-8>
<title>Android: YouTube Android Player API</title>
...
<p>Доступ к третьему месяцу обучения доступен только после оплаты второго месяца и составляет 210 руб.</p>

<p>Доступ к чётвертому месяцу обучения доступен после оплаты третьего месяца и составляет 210 руб. и т.д.</p>

<p>При оплате сразу четырех месяцев (2-5) - стоимость 800 руб, пяти месяцев (2-6) - 1000 руб.</p>

<p>Также возможен приём на PayPal. Обратите внимание, что в этом случае стоимость одного месяца составляет 8$.</p>
...
<input type="hidden" name="hosted_button_id" value="VRED2NRVE927N">
<input type="image" src="../../www.paypalobjects.com/ru_RU/i/btn/btn_paynow_LG.gif" border="0" name="submit" alt="PayPal — более безопасный и легкий способ оплаты через Интернет!">
<img alt="" border="0" src="../../www.paypalobjects.com/ru_RU/i/scr/pixel.html" width="1" height="1">
</form>
</p>			
...
<h1 class="text-warning">YouTube Android Player API</h1>
<p>Четвёртый месяц обучения (закрытая зона)</p>

<p>
<a href="#youtubeintent">Запускаем приложение YouTube через намерение</a><br>

</p>

<p><img src="../images/catvideos.png" alt="YouTube"></p>

<p>Метки: <span class="label">YouTube</span>, <span class="label label-success">YouTubeBaseActivity</span>, <span class="label label-warning">YouTubePlayerView</span></p>

<p>Вы вошли на сайт, как гость.<br><a href='register.html'>Необходимо зарегистрироваться</a>, чтобы прочитать статью</p>

<p>

</p>

<p>На данный момент API для воспроизведения видео с YouTube является экспериментальным, хотя разработчики уверяют, что кардинальных изменений не намечается. Поэтому уже сейчас можно пробовать внедрять возможность проигрывания видеороликов с YouTube в своих приложениях.</p>

<p>Как известно, самые распространённые ролики - это видео с котиками. Поэтому, вам определённо нужно изучить эту тему.</p>

<p>Использование YouTube Android Player API позволяет вам использовать методы для загрузки и проигрывания видеороликов и плейлистов, а также управлять видео в нужном режиме.</p>

<p>Просмотр видео осуществляется в отдельном компоненте (View), который вы можете вставить в свою разметку. Вы можете программно управлять состоянием плеера: воспроизведение, пауза, поиск нужного места и т.п. Также можно использовать фрагменты.</p>

<p>Вдобавок возможен просмотр в полноэкранном режиме, поддерживается смена ориентации и другие возможности.</p>

<div class="alert">
У пользователя должна стоять версия 4.2.16 приложения YouTube, чтобы можно было воспользоваться данным API.
</div>


<p><img src="images/youtubeandroidplayerapi1.png" alt="Готовое приложение" width="240" height="400"> <img src="images/youtubeandroidplayerapi2.png" alt="Готовое приложение" width="240" height="400"></p>
...
<!-- Mirrored from developer.alexanderklimov.ru/android/youtubeandroidplayerapi.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Jul 2014 15:19:18 GMT -->
</html>